<footer class="site-footer bg-light border-top py-2">
    <div class="container d-flex align-items-center justify-content-between">
        <ul class="footer-links d-flex list-unstyled mb-0">
            <li class="me-4"><a href="#" class="text-decoration-none text-dark">Privacy Policy</a></li>
            <li class="me-4"><a href="#" class="text-decoration-none text-dark">Terms of Service</a></li>
            <li class="me-4"><a href="#" class="text-decoration-none text-dark">FAQ</a></li>
